...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 15 16:54:01 2018

@author: garethjones
"""


''' LEAVE ONE OUT PREPROCESSING PIPELINES '''
...
def preprocess_pipeline(label_error,fft_hop_length,fmin,fmax,n_mels,n_fft,fft_window_size,model_hop_length,model_window_size):
    ...
    melslices_train_std, labels_train, train_mean, train_std = preprocessor.train_standardise(melslices_rebal_list[0:9], labels_rebal_list[0:9])
    
    # select 10th audio signal as test, and standardise using training mean and std
    melslices_test_std = preprocessor.test_standardise(melslices_rebal_list[9], train_mean, train_std)
